...
public class Salle {
    ...
    public Salle(Set<Equipement> equipements, List<Reservation> reservations, Integer etage, String batiment, String description, Integer capacite, String nom, Long id) {
